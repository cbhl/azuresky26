...
* Built a pipeline to retrieve PDFs and parts in a Product Lifecycle Management (PLM) system, add them to vector stores in OpenAI and Pinecone, and use them to improve responses in an in-app chat bot
...
* Added dimensions and metrics to the data warehouse so feature teams could track impact of their features on low-end devices
...
* Maintained legacy video editor frontends written in JavaScript (Google Closure Compiler) and collaborated with the team building the replacement in TypeScript
* Integrated [Mediapipe](https://developers.google.com/mediapipe) into server-side Editor service (C++)
...
* Various migrations: added column to database table primary key, static workflows to in-house Go / Golang framework, MySQL to Spanner, Python 2.x to C++ (Python 2.x turndown)
